          ...
          <Stack spacing={3} paddingY={2}>
            <Grid container spacing={0}>
              <Grid item xs={12} md={8} paddingRight={1}>
                <TextField fullWidth name="name" label="Nama" value={user.name} autoFocus required
                           onChange={(e) => setUser({
                             ...user,
                             name: e.target.value,
              ...
              <Grid item xs={12} md={4} paddingLeft={1}>
                <TextField fullWidth name="dob" label="Tanggal Lahir" type="date" value={user.dob}
            ...
            <Grid container spacing={0} sx={{paddingBottom: "4px"}}>
              ...
              <Grid item xs={12} md={6} paddingLeft={1}>
                <TextField fullWidth name="phone" label="Telephone" type="number" value={user.phone}
                           onChange={(e) => setUser({...user, phone: e.target.value})}/>
              </Grid>
            </Grid>

            <FormControl>
              <FormLabel id="available-label" sx={{textAlign: "center"}}>Role User</FormLabel>
              <RadioGroup
                sx={{paddingTop: "10px"}}
              ...
              >
                <Grid container spacing={0}>
                  ...
                  <Grid item xs={12} md={6} paddingLeft={1}>
                    <FormControlLabel value={false} control={<Radio/>} label="Siswa"
                                      sx={{textAlign: "center", justifyContent: "center", width: "100%"}}/>
                  </Grid>
                </Grid>
              </RadioGroup>
