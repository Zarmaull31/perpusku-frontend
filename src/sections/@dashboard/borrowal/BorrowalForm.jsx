      ...
      <Box sx={style}>
        <Container>
          <Typography variant="h4" textAlign="center" paddingBottom={2} paddingTop={1}>
            {isUpdateForm ? <span>Update</span> : <span>Tambah</span>} Pinjaman
          </Typography>
          <Stack spacing={3} paddingY={2}>
            ...
            <TextField fullWidth name="bookName" label="Nama Buku" type="text" value={borrowal.bookName}
                       onChange={(e) => setBorrowal({...borrowal, bookName: e.target.value})}/>

            <Grid container spacing={0} sx={{paddingBottom: "4px"}}>
              <Grid item xs={12} md={6} paddingRight={1}>
                <TextField fullWidth name="borrowedDate" label="Tanggal Pinjaman" type="date" value={borrowal.borrowedDate}
                           required
