      ...
      <Box sx={style}>
        <Container>
          <Typography variant="h4" textAlign="center" paddingBottom={2} paddingTop={1}>
            {isUpdateForm ? <span>Update</span> : <span>Tambah </span>} Buku
          </Typography>
              ...
              <Stack spacing={3} paddingY={2} paddingX={3}
                ...
                <TextField name="publishYear" label="Publish Year" value={book.publishYear} required
                  ...
                  <TextField
                    ...
                    onChange={(e) => setBook({ ...book, genreName: e.target.value })}
                    InputLabelProps={{
                      shrink: true,
                    }}
                  />
                ...
                <FormControl>
                  <FormLabel id="available-label">Ketersediaan</FormLabel>
                  <RadioGroup
                ...
                <TextField name="summary" label="Ringkasan" value={book.summary} multiline
                  rows={2}
                  maxRows={4}
